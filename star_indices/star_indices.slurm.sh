...
STAR --runThreadN 1 --runMode genomeGenerate --genomeDir ./clustered_longer_than_500.est_0.99/ --genomeFastaFiles /home/d.ence/d.ence_peter_share/pinus_taeda_L/miami_ohio_ESTs_ptaeda_rbh/combining_PacBio_miami_of_ohio/adding_V2.01_t3352/t3352.cdna.v1.contig.Pita.2_01.Feb_2020.cds.longer_than_500.est_0.99 clustered_longer_than_500.est_0.99  --limitGenomeGenerateRAM=36176571317 --genomeSAindexNbases 11

STAR --runThreadN 1 --runMode genomeGenerate --genomeDir ./clustered_longer_than_500.est_0.99/ --genomeFastaFiles /home/d.ence/d.ence_peter_share/pinus_taeda_L/miami_ohio_ESTs_ptaeda_rbh/t3352.cdna.v1.contig.fasta t3352.cdna.v1.contig  --limitGenomeGenerateRAM=36176571317 --genomeSAindexNbases 11

STAR --runThreadN 1 --runMode genomeGenerate --genomeDir ./clustered_longer_than_500.est_0.99/ --genomeFastaFiles /home/d.ence/d.ence_peter_share/pinus_taeda_L//miami_ohio_ESTs_ptaeda_rbh/combining_PacBio_miami_of_ohio/PacBio_transcriptome/Pita.IU.TranscriptomeMainsV1.102013.fasta PacBio  --limitGenomeGenerateRAM=36176571317 --genomeSAindexNbases 11
